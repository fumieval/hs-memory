...
toBase32Per5Bytes (W8# i1, W8# i2, W8# i3, W8# i4, W8# i5) =
  ...
  where
    -- 1111 1000 >> 3
    !o1 =     (uncheckedShiftRL# (and# (word8ToWord# i1) 0xF8##) 3#)
    -- 0000 0111 << 2 | 1100 0000 >> 6
    !o2 = or# (uncheckedShiftL#  (and# (word8ToWord# i1) 0x07##) 2#) (uncheckedShiftRL# (and# (word8ToWord# i2) 0xC0##) 6#)
    -- 0011 1110 >> 1
    !o3 =     (uncheckedShiftRL# (and# (word8ToWord# i2) 0x3E##) 1#)
    -- 0000 0001 << 4 | 1111 0000 >> 4
    !o4 = or# (uncheckedShiftL#  (and# (word8ToWord# i2) 0x01##) 4#) (uncheckedShiftRL# (and# (word8ToWord# i3) 0xF0##) 4#)
    -- 0000 1111 << 1 | 1000 0000 >> 7
    !o5 = or# (uncheckedShiftL#  (and# (word8ToWord# i3) 0x0F##) 1#) (uncheckedShiftRL# (and# (word8ToWord# i4) 0x80##) 7#)
    -- 0111 1100 >> 2
    !o6 =     (uncheckedShiftRL# (and# (word8ToWord# i4) 0x7C##) 2#)
    -- 0000 0011 << 3 | 1110 0000 >> 5
    !o7 = or# (uncheckedShiftL#  (and# (word8ToWord# i4) 0x03##) 3#) (uncheckedShiftRL# (and# (word8ToWord# i5) 0xE0##) 5#)
    -- 0001 1111
    !o8 =     ((and# (word8ToWord# i5) 0x1F##))
